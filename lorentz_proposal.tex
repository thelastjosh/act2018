...
Two keynote lectures at the tutorials will be given by \redout{John Baez and Prakash Panangaden}. Other events include introductory tutorials on diagrammatic reasoning, an introduction to Globular, a ``user's guide to operads and PROPs'', case studies of how to use these tools in applications, and a discussion of how to find new applications.
