...
9:00 - 10:00 & Arrival & & & \\
10:00 - 12:00 & Keynote: Diagrams (\redout{Vicary?}) & Data Analysis (\redout{Bubenik or Jost?}) & Linear Algebra (Sobocinski) & Dynamical Systems (Baez) \\ \hline
...
2:30 - 5:00 (incl. 30 min break) & Tutorial: Globular (\redout{Vicary?}) & Boat trip and school week dinner & Tutorial: ??? & Discussion + Problem Talks \\
...
Two keynote lectures at the tutorials will be given by \redout{John Baez and Pawel Sobocinski and Bob Coecke and Andrew Blumberg}. Other events include introductory tutorials on diagrammatic reasoning, an introduction to Globular, a ``user's guide to operads and PROPs'', case studies of how to use these tools in applications, a discussion of how to find new applications, and a working session dedicated to a constructing a survey of applied category theory (see below).
