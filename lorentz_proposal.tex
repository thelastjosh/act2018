...
2:30 - 5:00 (incl. 30 min break) & Tutorial: Globular (Vicary) & Boat trip and school week dinner & Tutorial (Baez) & Discussion + Problem Talks \\ \cline{1-2} \cline{4-5}
...
While the precise schedule for the program is still fluid, we have confirmed participation for key talks during the week by John Baez, Jamie Vicary, Pawel Sobocinski, and Jurgen Jost. PhD sessions will allow students to present, learn about, and discuss each other's research. Other events include introductory tutorials on diagrammatic reasoning, an introduction to Globular, a ``user's guide to operads and PROPs'', case studies of how to use these tools in applications, a discussion of how to find new applications, and a working session dedicated to a constructing a survey of applied category theory (see below).
...
To supplement the tutorial weekend, we will host an online seminar called the Kan Extension Lab targeted at 10-12 graduate students with existing knowledge either in category theory or in one of the topic areas listed below.
