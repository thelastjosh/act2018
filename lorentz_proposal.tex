...
In general then, our workshop will be considered a success if it (1) results in
joint research between researchers specializing in different applications (e.g.
physics and biology, or economics and AI) or in research that carries over
techniques from one application domain of category theory to another, and (2) if
the workshop introduces new researchers into the field.

More specifically, we will produce two documents to further these
aims. First, we will write a technical report summarising the presentations and discussion
sessions of the conference, with the intent to provide a list of promising
avenues for collaboration and a roadmap for work in applied category theory over
the next five years.

Second, through the tutorial week and its preceding online seminar, we will have
young researchers in applied category theory write a series of eight to ten
articles introducing landmark papers applying category theory to dynamical
systems and networks, systems biology, and computation, cognition, and AI. These
summary articles will be published online and---in addition to providing the
seminar participants with an entry point into the field---will form a permanent,
available, and accessible introduction to applied category theory.
...
10:00 - 10:30 & Dyn. Sys. & Highlights  & (Krivine) & (Jacobs)  & (TBC) \\ \cline{4-6}
...
\item Martha	Lewis,		Research Assistant	Oxford
...
\item Nina	Otter,		PhD student	Oxford
